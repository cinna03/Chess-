...
Deadline: **Friday 23:59**. Use this as your final gate before Canvas.
...
- [ ] 7–8 dated entries (ideation → build → polish → AI mode → submission)
...
- [ ] Unity Build: scene **ChessPlaytest** (macOS and/or Windows)
- [ ] Uploaded to **itch.io** (or similar), set **Public**
...
- [ ] Task allocation tracker: **you = edit**, teammate = **comment only**
...
One public-facing doc or Canvas text with:
...
- [ ] Submitted on Canvas **before Friday 23:59**
...
- [ ] README names filled (no `[Your Name]` placeholders)  
- [ ] No “request access” on any link  
- [ ] Backup copy of Canvas text in Drive  

---

## Suggested order (time left)

1. Push vs-computer code today  
2. DevLog + README media  
3. itch build  
4. Video (Q&A style)  
5. Canvas submit early (don’t wait until 23:50)  
